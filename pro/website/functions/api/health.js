...
export async function onRequestGet({ env }) {
  ...
  const affiliate = affiliateFlags(env);
  const checks = {
    ...
    affiliateRequested: env.AFFILIATE_ENABLED === "true",
    affiliateRedirectEnabled: affiliate.redirect,
    affiliateAttributionEnabled: affiliate.attribution,
    affiliateCommissionEnabled: affiliate.commission,
    affiliateAdminEnabled: affiliate.admin,
    affiliateProductionApproved: affiliate.productionApproved,
  ...
  const affiliateChecks = !checks.affiliateRequested || (
    checks.affiliateProductionApproved && checks.affiliateSigningConfigured && checks.affiliateInstallHashConfigured &&
