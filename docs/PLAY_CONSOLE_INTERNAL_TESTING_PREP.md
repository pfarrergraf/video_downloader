...
Use this document when Play Console access becomes available (expected ~10 days from 2026-07-03).
...
If a rebrand is desired (e.g. `de.geistreich.downloadthat`), it must happen before the first upload.
...
| Privacy policy URL | public HTTPS URL | `/datenschutz.html` or hosted equivalent |
...
PRO TIER (€1/month or yearly / lifetime)
...
PRIVACY
Nothing is sent to our servers during a download. Your download history stays on your device. See full privacy policy at: https://downloadthat.geistreich.com/datenschutz.html
