...
DECK = [
    ...
    {"de": dict(slide_kicker="Die Lösung",
                ...
                slide_content="<ul class=\"checks\"><li><b>1.</b> Teilen antippen — in jeder App</li><li><b>2.</b> DownloadThat im Teilen-Menü wählen</li><li><b>3.</b> Fertig — Video, MP3 oder Bild, lokal gespeichert</li></ul>Downloads laufen im Hintergrund weiter und setzen nach Abbrüchen selbst fort.",
                slide_side=_PHONE.format("screenshot_queue.png")),
     "en": dict(slide_kicker="The solution",
                slide_title=f"Share → DownloadThat → {_g('saved')}.",
                slide_content="<ul class=\"checks\"><li><b>1.</b> Tap share — from any app</li><li><b>2.</b> Pick DownloadThat in the share sheet</li><li><b>3.</b> Done — video, MP3 or image, saved locally</li></ul>Downloads keep running in the background and resume on their own after interruptions.",
                slide_side=_PHONE.format("screenshot_queue.png"))},
